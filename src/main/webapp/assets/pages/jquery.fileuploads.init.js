                            ...
                            <div class="jFiler-item-container">\
                                <div class="jFiler-item-inner">\
                                    ...
                                    <div class="jFiler-item-assets jFiler-row">\
                                        ...
                                        <!--<ul id="chk"class="list-inline pull-right">\
                                            <li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li>\
                                        </ul>-->\
                                    </div>\
                                </div>\
...
//                },400);
            	if(data=='verified'){
            		mp4.end(true);
    	            $('#processBar').delay(1200).fadeOut();
                	$('#gotoNewPassword').prop('disabled',false);
                	$('#qrUploadArea').hide();
                	$('.checkmark').show();
                	$('.text-muted').hide();
            	}else{
